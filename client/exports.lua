--- opx77_chat -- the public surface: the six exports the platform documents for a chat resource.
...
---@return table  `ok`, else `error`: export_call_required, no_surface, page_not_ready,
--- invalid_message
